...
CREATE TABLE "new_Shop" (
    ...
    "enableInactivityTrigger" BOOLEAN NOT NULL DEFAULT true,
...
INSERT INTO "new_Shop" ("accessToken", "allowSaleItems", "autoNegotiation", "autoValidityDuration", "botIcon", "botRejectMsg", "botSuccessMsg", "botWelcomeMsg", "chatTheme", "createdAt", "emailAcceptedBody", "emailAcceptedSubject", "emailCounterBody", "emailCounterSubject", "emailFont", "emailPrimaryColor", "emailRejectedBody", "emailRejectedSubject", "enableExitIntent", "enableInactivityTrigger", "fulfillmentMode", "gmailAppPassword", "gmailUser", "id", "isActive", "lastResetDate", "manualValidityDuration", "maxRounds", "negotiationCount", "plan", "priceRounding", "reactionMessages", "shopUrl", "smtpHost", "smtpPort", "strategy", "widgetColor", "widgetTemplate", "widgetTitle") SELECT "accessToken", "allowSaleItems", "autoNegotiation", "autoValidityDuration", "botIcon", "botRejectMsg", "botSuccessMsg", "botWelcomeMsg", "chatTheme", "createdAt", "emailAcceptedBody", "emailAcceptedSubject", "emailCounterBody", "emailCounterSubject", "emailFont", "emailPrimaryColor", "emailRejectedBody", "emailRejectedSubject", "enableExitIntent", "enableInactivityTrigger", "fulfillmentMode", "gmailAppPassword", "gmailUser", "id", "isActive", "lastResetDate", "manualValidityDuration", "maxRounds", "negotiationCount", "plan", "priceRounding", "reactionMessages", "shopUrl", "smtpHost", "smtpPort", "strategy", "widgetColor", "widgetTemplate", "widgetTitle" FROM "Shop";
DROP TABLE "Shop";
